...
const Nav = () => {
    ...
    return (
        <div className="navbar bg-base-100 z-10 shadow-lg px-4 sm:px-8 fixed ">
        <div className="flex-1">
          <a className="btn btn-ghost text-2xl gap-0 text-secondary">Byte<span className="text-primary">Blaze</span></a>
        </div>
